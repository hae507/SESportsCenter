...
<div class="box">
    <h1>강습 등록</h1>
    <form action="/Lesson/RegisterLesson.jsp" method="post">
        <label>강습 아이디</label>
        <input type="text" name="LessonId"/>
        <label>강사 Num</label>
        <input type="text" name="instructorNum"/>
        <label>강습 이름</label>
        <input type="text" name="LessonName"/>
        <label>강습 시간</label>
        <input type="text" name="LessonTime"/>
        <label>강습 가격</label>
        <input type="text" name="LessonPrice"/>
        <label>강습 할인율</label>
        <input type="text" name="LessonDCRate"/>
        <label>강습 체육센터명</label>
        <input type="text" name="SportsCenterName"/>
